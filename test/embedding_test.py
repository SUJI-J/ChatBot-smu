...
embedding_data = torch.load('C:/Users/uzald/PycharmProjects/ChatBot/train_tools/qna/embedding_data.pt')
df = pd.read_excel('C:/Users/uzald/PycharmProjects/ChatBot/train_tools/qna/train_data.xlsx')

# 질문 예시 문장
sentence = "스마트정보통신공학과 학과사무실 번호 알려줘"
