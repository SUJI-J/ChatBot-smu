...
# 말뭉치 데이터 읽어오기
movie_review = pd.read_csv('../../transform_data/movieReview.csv')
purpose = pd.read_csv('../../transform_data/conversationData.csv')
topic = pd.read_csv('../../transform_data/conversationData.csv')
common_sense = pd.read_csv('../../transform_data/commonSense.csv')
